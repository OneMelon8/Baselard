...
public class Register extends Command {
	...
	public Register(Bot bot) {
		super(bot, "register", new String[] { "reg", "regist" }, "Register a suit into the **temporary** database");
	}
	...
	public MessageEmbed getHelpEmbeded() {
		...
		builder.addField(new Field("Copy & Paste:", "```" + Messages.prefix
				+ "register type= name= grade= level= hp= atk= def= acc= eva= cntr= crt%= crit= stn= frz= sil= acd="
				+ "```", false));
